...
// ==================================================== //
export default function Records_Not_Pin({ ele }) {
    ...
    return <tr data-id={ele.id}>
        <td onClick={() => open_File(ele.file)} className="fw-bold cursor-pointer">{ele.name}</td>
        <td onClick={() => open_File(ele.file)} className="fw-bold cursor-pointer">{ele.sector}</td>
        <td onClick={() => open_File(ele.file)} className="fw-bold cursor-pointer">{ele.type}</td>
        <td onClick={() => open_File(ele.file)} className="fw-bold cursor-pointer">{ele.date}</td>

        <td onClick={() => handle_Editing_Record(ele.id)} id={Style.editing_btn} className={`cursor-pointer`}>
            <i className="fa-solid fa-pencil"></i>
        </td>

        <td onClick={() => handle_Thumbtack(ele)} id={Style.thumbtack_btn} className="cursor-pointer">
            {
        ...
        <td onClick={() => handle_Delete_Record(ele)} id={Style.delete_btn} className="cursor-pointer">
